...
//import com.example.jsonviewer.Model
...
class CustomAdapter(context: Context,arrayListDetails:ArrayList<Model>) : BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        listRowHolder.tvEmail.text = arrayListDetails.get(position).active
        listRowHolder.tvId.text = arrayListDetails.get(position).itemid
        return view
    }
}
